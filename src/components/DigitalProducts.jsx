...
const DigitalProducts = () => {
  return (
    <section className='lg:px-20 pt-48 pb-5'>
      ...
      <div className='grid lg:grid-cols-2 gap-14'>
        ...
        <div className='lg:order-1 grid gap-y-4'>
          ...
          <h2 className='text-[3.5rem] font-semibold leading-tight font-[serif-font]'>
          ...
          <button className='bg-[#4b2aad] px-6 py-3.5 rounded-full w-[50%] text-white text-xl font-bold'>
